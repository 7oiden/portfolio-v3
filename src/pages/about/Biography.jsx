  ...
  return (
    <section className="section-wrapper">
      ...
      <div className="paragraph-container">
        <p>
          I am originally from Sunnmøre, but moved to <em>Bergen</em> in 2004 to
          study, and has been living in the Bergen area more or less since.
        </p>
        <p>
        ...
        <p>
          ...
          well as being able to express my more creative and esthetic sides; the
          latter something i always missed in my previous line of work.
        </p>
        <p>
          As a person i am open-minded, self-reflected and curios, and i am
          always thirsting for knowledge and <em>eager to learn</em> new things
          to expand my horizon; both as a person and as a professional.
        </p>
      </div>
    </section>
  );
